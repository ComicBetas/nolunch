                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="ccm-dialog-help-item">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="hidden-xs"><a href="#" data-launch-guide="change-content"><?php echo t(' Change Content')?></a></li>
                                <li class="hidden-xs"><a href="#" data-launch-guide="add-content"><?php echo t('Guide: Add Content')?></a></li>
                            </ol>
                        </div>
                        <div class="ccm-dialog-help-item">
