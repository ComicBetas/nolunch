...
<div class="clearfix">
    ...
    ?>
			<li><label><input type="checkbox" name="ptIDInclude[<?php echo $entity->getAccessEntityID()?>][]" value="<?php echo $ct->getPageTypeID()?>" <?php if (in_array($ct->getPageTypeID(), $assignment->getPageTypesAllowedArray())) {
    ?> checked="checked" <?php 
}
    ?> /> <span><?php echo $ct->getPageTypeDisplayName()?></span></label></li>
		<?php 
}
    ?>
	</ul>
	<ul class="inputs-list">
		<li><label><input type="checkbox" name="allowExternalLinksIncluded[<?php echo $entity->getAccessEntityID()?>]" value="1" <?php if ($assignment->allowExternalLinks()) {
    ?>checked="checked" <?php 
}
    ?> /> <span><?php echo t('Allow External Links')?></span></label></li>
	</ul>
...
<div class="clearfix">
    ...
    ?>>
		<?php foreach ($pageTypes as $ct) {
    ?>
			<li><label><input type="checkbox" name="ptIDExclude[<?php echo $entity->getAccessEntityID()?>][]" value="<?php echo $ct->getPageTypeID()?>" <?php if (in_array($ct->getPageTypeID(), $assignment->getPageTypesAllowedArray())) {
    ?> checked="checked" <?php 
}
    ?> /> <span><?php echo $ct->getPageTypeDisplayName()?></span></label></li>
		<?php 
	...
	<ul class="inputs-list">
		<li><label><input type="checkbox" name="allowExternalLinksExcluded[<?php echo $entity->getAccessEntityID()?>]" value="1" <?php if ($assignment->allowExternalLinks()) {
    ?>checked="checked" <?php 
}
    ?> /> <span><?php echo t('Allow External Links')?></span></label></li>
	</ul>
