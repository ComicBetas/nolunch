...
if ($user->isLoggedIn()) {
    ...
    <div class="form-group">
        <a href="<?php echo \URL::to('/ccm/system/authentication/oauth2/facebook/attempt_attach');
...
<?php
    ...
    <div class="form-group">
        <a href="<?php echo \URL::to('/ccm/system/authentication/oauth2/facebook/attempt_auth');
    ?>" class="btn btn-primary btn-facebook btn-block">
            <i class="fa fa-facebook"></i>
