...
<fieldset>
    ...
    ?>selected<?php 
} ?>><?php echo t('Search – Display a list of all topics for use on a search sidebar.')?></option>
            <option value="P" <?php if ($mode == 'P') {
    ?>selected<?php 
} ?>><?php echo t('Page – Display a list of topics for the current page.')?></option>
        </select>
    </div>
    ...
    ?>
                <option value="<?php echo $attributeKey->getAttributeKeyHandle()?>" <?php if ($attributeKey->getAttributeKeyHandle() == $topicAttributeKeyHandle) {
    ?>selected<?php 
}
