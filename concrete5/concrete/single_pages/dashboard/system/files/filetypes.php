<?php defined('C5_EXECUTE') or die("Access Denied."); ?>
    ...
    <form method="post" id="file-access-extensions" action="<?php echo $view->action('file_access_extensions')?>" role="form">
        ...
        <div class="form-group">
            <label class="control-label launch-tooltip" title="<?php echo t('Only files with the following extensions will be allowed. Separate extensions with commas. Periods and spaces will be ignored.')?>" for="file-access-file-types"><?php echo t('File Extensions to Accept')?></label>
