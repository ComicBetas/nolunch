...
<section class="ccm-ui">
    ...
    ?>
			<div class="alert alert-info"><?php echo t('This page inherits its permissions from the drafts area, as well as its edit page type drafts permission.');
    ?></div>
		<?php 
} else {
    ?>
			<div class="alert alert-info"><?php echo t('This page inherits its permissions from:');
    ?> <a target="_blank" href="<?php echo URL::to($cpc)?>"><?php echo $cpc->getCollectionName()?></a></div>
		<?php 
}
        ?>
	<?php 
	...
	<div>
		<div class="form-group">
			<label class="control-label" for="ccm-page-permissions-inherit"><?php echo t('Assign Permissions')?></label>
    ...
    ?>><?php echo t('By Area of Site (Hierarchy)')?></option><?php
    ...
    ?>><?php echo t('From Page Type Defaults')?></option><?php

} ?>
			<option value="OVERRIDE" <?php if ($c->getCollectionInheritance() == 'OVERRIDE') {
    ?> selected<?php

} ?>><?php echo t('Manually')?></option>
			</select>
		</div>
	<?php if (!$c->isMasterCollection()) {
    ?>
		<div class="form-group">
			<label class="control-label" for="ccm-page-permissions-subpages-override-template-permissions"><?php echo t('Subpage Permissions')?></label>
    ...
    ?>><?php echo t('Inherit page type default permissions.')?></option>
				<option value="1"<?php if ($c->overrideTemplatePermissions()) {
    ?>selected<?php

}
    ?>><?php echo t('Inherit the permissions of this page.')?></option>
			</select>
		</div>
	<?php
