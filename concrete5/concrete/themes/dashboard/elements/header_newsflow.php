...
<div class="well" style="margin-bottom: 0px">
    ...
    ?>
	<?php if (!$_c->isCheckedOut()) {
    ?><a href="<?php echo DIR_REL?>/<?php echo DISPATCHER_FILENAME?>?cID=<?php echo $c->getCollectionID()?>&ctask=check-out<?php echo $token?>" id="ccm-nav-check-out" class="btn"><?php echo t('Edit Page')?></a><?php 
}
    ?>
</div>
<?php 
